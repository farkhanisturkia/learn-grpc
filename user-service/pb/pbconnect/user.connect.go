...
const (
	...
	UserServiceName = "pb.UserService"
)
...
const (
	...
	UserServiceDeleteUserProcedure = "/pb.UserService/DeleteUser"
)

// UserServiceClient is a client for the pb.UserService service.
...
// NewUserServiceClient constructs a client for the pb.UserService service. By default, it uses the
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		createUser: connect.NewClient[pb.CreateUserRequest, pb.User](
			httpClient,
		...
		deleteUser: connect.NewClient[pb.DeleteUserRequest, pb.EmptyUserResponse](
			httpClient,
...
func (c *userServiceClient) CreateUser(ctx context.Context, req *connect.Request[pb.CreateUserRequest]) (*connect.Response[pb.User], error) {
...
func (c *userServiceClient) UpdateUser(ctx context.Context, req *connect.Request[pb.UpdateUserRequest]) (*connect.Response[pb.User], error) {
	return c.updateUser.CallUnary(ctx, req)
}

// DeleteUser calls pb.UserService.DeleteUser.
func (c *userServiceClient) DeleteUser(ctx context.Context, req *connect.Request[pb.DeleteUserRequest]) (*connect.Response[pb.EmptyUserResponse], error) {
	return c.deleteUser.CallUnary(ctx, req)
}

// UserServiceHandler is an implementation of the pb.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/pb.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[pb.CreateUserRequest]) (*connect.Response[pb.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pb.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[pb.UpdateUserRequest]) (*connect.Response[pb.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pb.UserService.UpdateUser is not implemented"))
}

func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[pb.DeleteUserRequest]) (*connect.Response[pb.EmptyUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pb.UserService.DeleteUser is not implemented"))
}
